...
class AddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create address" do
    assert_difference("Address.count") do
      post addresses_url, params: { address: { city: @address.city, country: @address.country, latitude: @address.latitude, longitude: @address.longitude, state: @address.state, street: @address.street, zipcode: @address.zipcode } }
    end
